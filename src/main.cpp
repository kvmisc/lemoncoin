...
#if defined(NDEBUG)
# error "Lemoncoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x77f1fc4296cd1c9f4e40df224d27df295de08f505a4cfd988d53ca9857bc2791");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Lemoncoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Lemoncoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Lemoncoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd9a7bac27d06df4bcd841e103cb6f827cacf2839ea4f41292a178c5765bba2bd");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "The Times 23/Dec/2019 The ups and downs of Downing Street";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c32661017cb26e20c9f21b67c5b863efce46fc936a54dd7059ca3d5e76feeeab2d9f4b416c29f2cf1cfc3e08899f63748a800c34e4677406ec8d906744fd31a8") << OP_CHECKSIG;
        CBlock block;
        ...
        block.nNonce   = 2088170200;

        if (fTestNet)
        {
            block.nTime    = 1577283216;
            block.nNonce   = 386732677;
        }
...
unsigned char pchMessageStart[4] = { 0x4c, 0x4d, 0x43, 0x31 }; // Lemoncoin: increase each by adding 2 to bitcoin's value.
